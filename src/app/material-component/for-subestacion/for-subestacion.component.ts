...
@Component({
  selector: 'app-for-subestacion',
  templateUrl: './for-subestacion.component.html',
  styleUrls: ['./for-subestacion.component.scss']
})
export class ForSubestacionComponent {
  pdfUrl: SafeResourceUrl = this.sanitizer.bypassSecurityTrustResourceUrl('/assets/pdf/plantilla1.pdf');
