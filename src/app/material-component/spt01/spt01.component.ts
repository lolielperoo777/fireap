...
@Component({
  selector: 'app-spt01',
  templateUrl: './spt01.component.html',
  styleUrls: ['./spt01.component.scss']
})
export class Spt01Component {
  pdfUrl: SafeResourceUrl = this.sanitizer.bypassSecurityTrustResourceUrl('/assets/pdf/plantilla2.pdf');
